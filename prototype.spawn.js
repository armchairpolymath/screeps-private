...
StructureSpawn.prototype.spawnCreepsIfNecessary =
    function () {
        ...
        if (name != undefined && _.isString(name)) {
            ...
            console.log("Red for repair | Blue for Building | Green for Harvesting | Yellow for Upgrading | White for Lorry");
            console.log(this.name + " spawned new creep: " + name + " (" + Game.creeps[name].memory.role + ")");
            for (let role of listOfRoles) {
                console.log(role + ": " + numberOfCreeps[role]);
            }
            for (let     in numberOfLongDistanceHarvesters) {
...
StructureSpawn.prototype.createCustomCreep =
    function (energy, roleName) {
        ...
        return this.createCreep(body, undefined, { role: roleName, working: false, roleChange: false });
    };
...
StructureSpawn.prototype.createSigner  =
    function (signContent) {
        return this.createCreep([MOVE], undefined, {role: 'signer', roomSign: signContent });
    };
